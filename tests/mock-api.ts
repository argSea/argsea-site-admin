	...
	projects: Doc[] = [
		{
			...
			light: { kind: 'flash', color: 'white', period: 8, extinguished: '' },
		...
		},
		{
			...
			light: { kind: 'flash', color: 'green', period: 4, extinguished: '' },
		...
		},
		{
			...
			light: { kind: 'fixed', color: 'red', period: 0, extinguished: '' },
		...
		},
		{
			...
			light: { kind: 'iso', color: 'white', period: 3, extinguished: '' },
