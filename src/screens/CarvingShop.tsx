...
const SPOT_HINTS: Record<string, string> = {
	...
	'morse-seal': 'keep the lamp anchor, the page blinks hi in morse through it.',
	'panel-rose': 'keep the viewBox, it sits small in the panel corner.',
	'fleet-wake': 'keep it one loose line, it plots behind the pills edge to edge.',
	'chart-rose': 'keep the viewBox, north is decorative but the chart leans on it.',
	'sea-serpent': 'keep it long and low, it swims the here-be-dragons corner.',
	'moored-lamp': 'keep the lamp anchor so the light can still pulse.',
	'adrift-boat': 'keep the viewBox, it drifts the chart at mark size.',
	'adrift-wake': 'keep the dashes loose, they trail the boat.',
	'marooned-palm': 'keep it rooted low, it sways from the sandbar.',
	'port-anchor': 'keep the viewBox, it hangs at mark size under the pennants.',
	'signal-flare': 'keep it small, it rides the button on the bearing card.',
	'compass-rose-star': 'keep it centered, it blooms overhead when a flare goes up.',
	'sail-tent': 'keep it light, it floats over the blooming flare.',
	gull: 'keep it one stroke, it wheels over the shallows.',
	'route-line': 'keep the dashes, the course has to die at the sand.',
